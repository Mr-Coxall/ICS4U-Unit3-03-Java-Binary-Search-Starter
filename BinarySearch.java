...
final class BinarySearch {
    ...
    *
    * @param userArray is the randomly generated array.
    * @param userNumber is the number inputted by the user.
    * @param lowIndex is the lower range to search.
    * @param highIndex is the higher range to search.
    * @return the index after recursively finding userNumber.
    */
